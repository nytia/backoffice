                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>Nike air</td>
                                            <td>01-02-22</td>
                                            <td><label class="badge badge-danger">Valider</label></td>
                                        </tr>
                                        <tr>
                                            <td>Jacob</td>
                                            <td>tenis</td>
                                            <td>Nike air</td>
                                            <td>01-02-22</td>
                                            <td><label class="badge badge-warning">Valider</label></td>
                                        </tr>
                                        <tr>
                                            <td>Jacob</td>
                                            <td>tenis</td>
                                            <td>Nike air</td>
                                            <td>01-02-22</td>
                                            <td><label class="badge badge-info">Valider</label></td>
                                        </tr>
                                        <tr>
                                            <td>Jacob</td>
                                            <td>tenis</td>
                                            <td>Nike air</td>
                                            <td>01-02-22</td>
                                            <td><label class="badge badge-success">Valider</label></td>
                                        </tr>
                                        <tr>
                                            <td>Jacob</td>
                                            <td>tenis</td>
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <input style = "height: 35px" type="text" class="form-control" id="exampleInputUsername2" placeholder="categorie">
                                        </div>
                                        <div class="col-sm-4">
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <input style = "height: 35px" type="text" class="form-control" id="exampleInputUsername2" placeholder="Commission">
                                        </div>
                                        <div class="col-sm-4">
